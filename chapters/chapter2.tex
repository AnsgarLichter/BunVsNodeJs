...
\begin{figure}[h]
	...
	\caption[Vergleich der Ökosysteme von Bun und Node.js]{Vergleich der Ökosysteme von Bun und Node.js \cite{Springer.2022, Bun.}}
...
\begin{itemize}
	...
	\item Globale Objekte: btoa, atob.\cite{OvenSh.2023b} 
\end{itemize} 

\noindent
Allerdings existieren auch viele Module und globale Objekte, für die die Unterstützung teilweise oder komplett fehlen, zum Beispiel \glqq tel\grqq{}, \glqq net\grqq{} oder \glqq http2\grqq{} \cite{OvenSh.2023b}. Daraus folgt, dass die Kompatibilität von bestehenden Node.js-Projekten von den verwendeten Objekten und Modulen abhängt.
