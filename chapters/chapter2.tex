...
\noindent
Demnach beschreibt Performance die Reaktion eines Systems auf die Durchführung einer Aktion über einen definierten Zeitraum. Um die Performance einer Software bestimmen zu können, stellt ISO / IEC 25010 3 Charakteristiken zur Verfügung (siehe Abbildung \ref{fig:softwareQuality}):
\begin{itemize}
	\item Zeitverhalten: das Maß, in dem die Reaktions-, Verarbeitungszeiten und Durchsatzraten einer Software bei der Ausführung den definierten Anforderungen entsprechen.
	\item Ressourcennutzung: das Maß, in dem die Menge und Art der Ressourcen, die ein Produkt bei der Ausführung seiner Funktionalitäten beansprucht, den Anforderungen entsprechen.
	\item Kapazität: das Maß, in dem die maximalen Grenzen eines Parameters einer Software den Anforderungen entsprechen. \cite{ISOIEC.}
\end{itemize}

\noindent
Das Zeitverhalten ....\todo{auf alle 3 Charakteristika eingehen}\\

\noindent
Um die Performance einer produktiven Software zu bestimmen, nutzt man Benchmarks. \todo{Benchmarks - Was und Wie?}\\