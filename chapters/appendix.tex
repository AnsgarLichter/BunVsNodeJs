...
\begin{landscape}
	...
	\begin{longtable}{
		...
		\caption{HTTP-Server - Ergebnisse von Bun auf macOS}
		\label{tab:macos} \\
		\toprule
	...
	\begin{longtable}{
		...
		\caption{HTTP-Server - Ergebnisse von Node.js LTS auf macOS)}
	...
	\begin{longtable}{
		...
		\caption{HTTP-Server - Ergebnisse von Node.js Latest auf macOS}
	...
	\begin{longtable}{
		...
		\caption{HTTP-Server - Ergebnisse von Bun auf Ubuntu 23.10}
		\label{tab:ubuntu} \\
		\toprule
	...
	\begin{longtable}{
		...
		\caption{HTTP-Server - Ergebnisse von Node.js LTS auf Ubuntu 23.10}
	...
	\begin{longtable}{
		...
		\caption{HTTP-Server - Ergebnisse von Node.js Latest auf Ubuntu 23.10}
...
\begin{landscape}
	...
	\begin{longtable}{
		...
		\caption{Datei-Server - Ergebnisse von Bun auf Ubuntu 23.10}
	...
	\begin{longtable}{
		...
		\caption{Datei-Server - Ergebnisse von Node.js LTS auf Ubuntu 23.10}
	...
	\begin{longtable}{
		...
		\caption{Datei-Server - Ergebnisse von Node.js Latest auf Ubuntu 23.10}
	...
	\begin{longtable}{
		...
		\caption{Datei-Server - Ergebnisse von Bun auf macOS}
	...
	\begin{longtable}{
		...
		\caption{Datei-Server - Ergebnisse von Node.js LTS auf macOS}
	...
	\begin{longtable}{
		...
		\caption{Datei-Server - Ergebnisse von Node.js Latest auf macOS}
	...
	\begin{longtable}{c S[table-format=2.2] c S[table-format=5.0]}
		\caption{Berechnung der Fibonacci-Folge - Ergebnisse auf MacOS} \\
		\toprule
		\multicolumn{4}{c}{Bun} \\
	...
	\begin{longtable}{c S[table-format=2.2] c S[table-format=5.0]}
		\caption{Berechnung der Fibonacci-Folge - Ergebnisse auf Ubuntu 23.10} \\
		\toprule
		\multicolumn{4}{c}{Bun} \\
		Nr. & {Ausführungszeit (s)} & {CPU-Auslastung} & {Maximale RAM-Nutzung (kbytes)} \\
		\midrule
